...
class Account extends Controller
{
    ...
    //     $body = 'Click vào đây để hoàn thành đăng ký của bạn: <a href="http://localhost/ecomerce2/signup-comfirm/' . $token . '">Xác nhận</a> Đường dẫn sẽ hết hạn trong 15 phút.';
    ...
    //registerApi moi thêm vào 23/9/2025
    function registerApi()
    {
        $type = 'error';
        $dataPost = $this->req->getFields();
        ...
        // Gán quyền mặc định
        $role_id = 3; // 1=Quản trị viên, 2=Người bán hàng, 3=Khách hàng
        ...
        if ($success) {
            echo json_encode(['success' => 'Đăng ký thành công! Bạn có thể đăng nhập ngay.']);
        } else {
            echo json_encode(['error' => 'Đã có lỗi xảy ra, vui lòng đăng ký lại.']);
        }
    }
    ...
    function forgotPasswordApi()
    {
        ...
        $body = 'Click vào đây để xác nhận email của bạn: <a href="http://localhost/ecomerce2/account/finalForgotPassword/' . $token . '">Xác nhận</a> Đường dẫn sẽ hết hạn trong 15 phút.';
