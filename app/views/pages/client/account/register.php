        ...
        <div class="col-lg-6 offset-xl-2">
            <div class="signin-form-wrap">
                <div class="signin-form-main">
                    ...
                    <!-- mới thêm enctype="multipart/form-data" vào  -->
                    <form class="singin-form" id="formRegister" method="POST" enctype="multipart/form-data">
                        ...
                        <!-- <div class="form-group">
                            ...
                            <input type="password" class="form-control" id="re_passwordLogin" name="re_password" placeholder="Nhập lại mật khẩu" required>
                            <div class="invalid-feedback">
